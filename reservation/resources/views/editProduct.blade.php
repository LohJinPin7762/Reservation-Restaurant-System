        ...
        <form action="{{ route('updateProduct') }}" method="POST" enctype="multipart/form-data" >
           ...
           @foreach($products as $product)
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="productType" name="productType" value="{{$product->type}}" >                
            </div>
            <div class="form-group">
                <label for="productPrice">Product Price</label>
                <input type="text" class="form-control" id="productPrice" name="productPrice" min="0" value="{{$product->price}}">                
            </div>
            <div class="form-group">
                <label for="productPrice">Product Available</label>
                <input type="number" class="form-control" id="productAvailable" name="productAvailable" min="0" Max="10" value="{{$product->available}}">                
            </div>
